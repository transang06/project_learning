    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diaChi', models.CharField(blank=True, max_length=1000, null=True)),
                ('namSinh', models.DateField(blank=True, null=True)),
                ('gioiTinh', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            name='SoThich',
            fields=[
                ('sothichId', models.AutoField(primary_key=True, serialize=False)),
                ('ten', models.CharField(blank=True, max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='SoThich_User',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('SoThich', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='home.sothich')),
